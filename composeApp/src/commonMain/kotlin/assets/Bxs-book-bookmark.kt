...
public val Assets.`Bxs-book-bookmark`: ImageVector
    get() {
        if (`_bxs-book-bookmark` != null) {
            return `_bxs-book-bookmark`!!
        }
        `_bxs-book-bookmark` = Builder(name = "Bxs-book-bookmark", defaultWidth = 24.0.dp,
...
private var `_bxs-book-bookmark`: ImageVector? = null
