...
public val Assets.`Bookmark-alt`: ImageVector
    get() {
        if (`_bookmark-alt` != null) {
            return `_bookmark-alt`!!
        }
        `_bookmark-alt` = Builder(name = "Bookmark-alt", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bookmark-alt`: ImageVector? = null
